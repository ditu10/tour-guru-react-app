const commonFAQ = [
    ...
    },
    {
        ...
        "content": "No worries, please contact the number found in booking confirmation email under the “contact tour operator/guide” section for updates.",
        "details": []
    },
    {
        "title": "Who should I contact if I need to change my booking information?",
        "content": "For changes to your pick-up address, phone number or email, please let your local tour operator know. Their information can be found in booking confirmation email under “contact tour operator/guide”.",
        "details": []
    },
    {
        "title": "What should I do if I want to change dates?",
        "content": "Contact TripGuru. Our email: {{email}} , Hotline: {{hotline}}, WhatsApp(chat only): {{whatsApp}}, or talk to us through the online chat. Please note that last minute changes may not be accepted due to late notice.",
        "details": []
    }
];
...
const bookingProcessFAQ = [
    {
        ...
        "content": "Find your preferred tour, click ‘see dates’ button, select your tour date then number of people, leave your contact information, continue to the payment page, and get your booking confirmation email. Start the adventure!",
        "details": []
    },
    {
        "title": "What does ‘Instant Confirmation’ mean when booking a tour?",
        "content": "Some of our tours are marked ‘Instant Confirmation’, which means you will be able to receive an instant confirmation of your booking via the email address you registered with TripGuru. You’ll also be able to see your confirmed booking, with all the necessary details, on your personal booking dashboard.",
        "details": []
    },
    {
    ...
    },
    {
        ...
        "content": "At the moment we only support transactions in U.S. dollars. If you’re from another area, your credit card should automatically convert the charges into your local currency.",
        "details": []
    },
    {
    ...
    },
    {
        ...
        "content": "Unfortunately, TripGuru does not support payments in cash at the moment and our physical offices do not handle ticketing and booking.",
        "details": []
    }
];
...
const cancellationFAQ = [
    {
        ...
        "content": "Yes, please contact TripGuru and we will offer you final confirmation about the cancellation. Our email: {{email}}. Please note that last minute changes may not be accepted due to late notice.",
        "details": []
    },
    {
        "title": "Can I get a refund for the cancellation?",
        "content": "Please contact our support team directly if you need to cancel your tour. Check on the tour page since different cancellation policies apply to different tours. Our team will reply you with the final cancellation confirmation.",
        "details": []
    },
    {
