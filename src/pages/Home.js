    ...
    <div>
      ...
      <section className="text-center mt-4 container-fluid">
        ...
        <h3 className="text-secondary">
          Discover eco-friendly experiences based on your interests
        </h3>
                    ...
                    <div className="card border-0" style={{ height: "24rem" }}>
                      ...
                      >
                        <div>
                          ...
                          <h5 className="text-white border rounded-pill">
                            Discover {category.tour_count} tours
                          </h5>
                        </div>
                      </div>
                    </div>
      ...
      <section className="container-fluid text-center mt-5">
        <div>
          ...
          <h3 className="text-secondary">
            Choose from 25 enchanting cities and over 350 eco-friendly guided
            experiences
          </h3>
        </div>
            ...
            if (index < 8)
              return (
                <div className="col-lg-3 col-md-6 col-12 mb-4">
                  <NavLink
                    className="text-decoration-none"
                    to={`/destination/${favourite.slug}`}
                  >
                    <div className="card border-0" style={{ height: "24rem" }}>
                      <div
                        className="card-body d-flex align-items-end justify-content-center rounded"
                        style={{
                          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(${url})`,
                          backgroundSize: "cover",
                        }}
                      >
                        <div>
                          ...
                          <h5 className="text-white border rounded-pill px-3">
                            Discover {favourite.tour_count} tours
                          </h5>
                        </div>
                      </div>
                    </div>
